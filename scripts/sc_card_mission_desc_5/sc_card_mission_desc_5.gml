...
CardMissionBasic_Desc_5_Token[cardMissionBasicNumber] = spr_token_nothing;
	...
	CardMissionBasic_Desc_5[cardMissionBasicNumber] = "Pokud držíš kartu"+string_quote(string_upper(argument1))+string("\n,tak je ihned nahrazena touto kartou a druhá je zničena.");	
		};
...
CardMissionSecure_Desc_5_Token[cardMissionSecureNumber] = spr_token_nothing;
	...
	CardMissionSecure_Desc_5[cardMissionSecureNumber] = "Pokud držíš kartu"+string_quote(string_upper(argument1))+string("\n,tak je ihned nahrazena touto kartou a druhá je zničena.");	
		};
...
CardMissionSabotage_Desc_5_Token[cardMissionSabotageNumber] = spr_token_nothing;
	...
	CardMissionSabotage_Desc_5[cardMissionSabotageNumber] = "Pokud držíš kartu"+string_quote(string_upper(argument1))+string("\n,tak je ihned nahrazena touto kartou a druhá je zničena.");	
		};
