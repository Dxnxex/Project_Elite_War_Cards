function sc_card_rewards_draw_specific_at_pos(argument0,argument1,argument2){
...
if i <= CardRewardNumberMaxAll {
	...
	Type[(argument0-1)+3*(argument1-1)] = spr_cardart_back_rewards;
	} else {Type[(argument0-1)+3*(argument1-1)] = spr_cardart_back_nothing};
