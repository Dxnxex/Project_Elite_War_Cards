...
if i <= ctnMaxAll {
		...
		#region ATRIBUTES
						...
						if CardTechniquesProp_1_Active[i] == 1 {
							...
							//-----Token-----
							setLenghtdir(508.18,-169.40);	drawToken(CardTechniquesProp_1_Token[i]);
							...
							setLenghtdir(530.17,-10.38);			if CardTechniquesProp_1_add_raw[i]!=0 {sc_draw_card_arrow();}
								...
								//-----Atributes-----
								setFont(fo_techniques_inside_left);		setLenghtdir(415.39,-166.85);		setTextAlign(fa_middle,fa_left);		textShadow(string_upper(CardTechniquesProp_1[i]),c_white);		
								...
								setFont(fo_techniques_number);	setLenghtdir(341.55,-15.89);			setTextAlign(fa_middle,fa_center);		textShadow((CardTechniquesProp_1_how[i]),c_white);
						...
						if CardTechniquesProp_2_Active[i] == 1 {
							...
							//-----Token-----
							setLenghtdir(555.67,-153.78);	drawToken(CardTechniquesProp_2_Token[i]);
							...
							setLenghtdir(573.26,-25.25);			if CardTechniquesProp_2_add_raw[i]!=0 {sc_draw_card_arrow();};
								...
								//-----Atributes-----
								setFont(fo_techniques_inside_left);		setLenghtdir(472.32,-148.68);		setTextAlign(fa_middle,fa_left);		textShadow(string_upper(CardTechniquesProp_2[i]),c_white);		
								...
								setFont(fo_techniques_number);	setLenghtdir(409.30,-36.86);			setTextAlign(fa_middle,fa_center);		textShadow((CardTechniquesProp_2_how[i]),c_white);
						...
						if CardTechniquesProp_3_Active[i] == 1 {
							...
							//-----Token-----
							setLenghtdir(640.39,-141.40);	drawToken(CardTechniquesProp_3_Token[i]);
							...
							setLenghtdir(653.95,-37.54);			if CardTechniquesProp_3_add_raw[i]!=0 {sc_draw_card_arrow();};
								...
								//-----Atributes-----
								setFont(fo_techniques_inside_left);		setLenghtdir(563.56,-135);		setTextAlign(fa_middle,fa_left);		textShadow(string_upper(CardTechniquesProp_3[i]),c_white);		
								...
								setFont(fo_techniques_number);	setLenghtdir(512.36,-50.70);			setTextAlign(fa_middle,fa_center);		textShadow((CardTechniquesProp_3_how[i]),c_white);
						...
						if CardTechniquesProp_4_Active[i] == 1 {
							...
							//-----Token-----
							setLenghtdir(743.48,-132.00);	drawToken(CardTechniquesProp_4_Token[i]);
							...
							setLenghtdir(754.82,-46.72);			if CardTechniquesProp_4_add_raw[i]!=0 {sc_draw_card_arrow();};
								...
								//-----Atributes-----
								setFont(fo_techniques_inside_left);		setLenghtdir(680.77,-126.04);		setTextAlign(fa_middle,fa_left);		textShadow(string_upper(CardTechniquesProp_4[i]),c_white);		
								...
								setFont(fo_techniques_number);	setLenghtdir(640.04,-59.33);			setTextAlign(fa_middle,fa_center);		textShadow((CardTechniquesProp_4_how[i]),c_white);
		...
		#region POPIS KARTY
			...
			setTextSizeAndWidth(42,1185);	textShadow(CardTechniques_TXT[i],c_white);
