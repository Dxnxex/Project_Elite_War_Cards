function sc_card_events_draw_at_pos(argument0,argument1){
...
//Position variables
posX = ((CardWidth+formatBetween)*argument1-wsprite)-((CardWidth)*1-wsprite)/2;
posY = ((CardHeight+formatBetweenH)*argument0-hsprite)-((CardHeight)*1-hsprite)/2;

//Image Placement
var i = (card_event_numberAll+(argument0-1)+CardNumber*(argument1-1));
