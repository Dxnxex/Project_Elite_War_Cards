...
function sc_card_shop_draw_at_pos(argument0,argument1){
...
//Position variables
xx = ((CardWidth)*argument1-wsprite)-((CardWidth)*1-wsprite)/2;
yy = ((CardHeight)*argument0-hsprite)-((CardHeight)*1-hsprite)/2;

//Image Placement
var i = (card_shop_numberAll+(argument0-1)+CardNumber*(argument1-1));
var Radius = 165;
var ImageScale = ((wsprite-Radius*2)/sprite_get_width(card_shop_image))*iscale;

	if i <= card_shop_numberMaxAll {
