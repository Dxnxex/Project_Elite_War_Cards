...
repeat(basicNumberMax+1) {
			...
			sc_cardback_PDF_pre();
			sprite_save(surfaceSprite, 0,string(working_directory+string("Single/")+string("Basic - ")+string(PDF_P_Add)+string(PDF_P)+string(".")+string("png")));		
