...
if screenshot_start_single == 1 { 
		...
		if ctn>23 {T_Offset=60};
			...
			if screenshot_start == 1 && Screnshot_DELAY==0 {if card_shop_number!=(card_shop_numberMax+1)							{screen_save_part(string(working_directory+string("Single/")+string("Shop (")+string(card_shop_number+1)+string(")."+string(ScreenshotFormat))),0,0,getScreenshotWidth(),getScreenshotHeight());card_shop_number++;} else {screenshot_start++;Screnshot_DELAY = Screnshot_DELAY_par;} };
			if screenshot_start == 2 && Screnshot_DELAY==0 {if cardMissionBasicNumber!=(cardMissionBasicNumberMax+1)				{screen_save_part(string(working_directory+string("Single/")+string("Mission - Basic (")+string(cardMissionBasicNumber+1)+string(")."+string(ScreenshotFormat))),0,0,getScreenshotWidth(),getScreenshotHeight());cardMissionBasicNumber++;}				else {screenshot_start++;Screnshot_DELAY = Screnshot_DELAY_par;}};
			if screenshot_start == 3 && Screnshot_DELAY==0 {if cardMissionSecureNumber!=(cardMissionSecureNumberMax+1)				{screen_save_part(string(working_directory+string("Single/")+string("Mission - Secure (")+string(cardMissionSecureNumber+1)+string(")."+string(ScreenshotFormat))),0,0,getScreenshotWidth(),getScreenshotHeight());cardMissionSecureNumber++;}			else {screenshot_start++;Screnshot_DELAY = Screnshot_DELAY_par;}};
			if screenshot_start == 4 && Screnshot_DELAY==0 {if cardMissionSabotageNumber!=(cardMissionSabotageNumberMax+1)			{screen_save_part(string(working_directory+string("Single/")+string("Mission - Sabotage (")+string(cardMissionSabotageNumber+1)+string(")."+string(ScreenshotFormat))),0,0,getScreenshotWidth(),getScreenshotHeight());cardMissionSabotageNumber++;}		else {screenshot_start++;Screnshot_DELAY = Screnshot_DELAY_par;}};
			if screenshot_start == 5 && Screnshot_DELAY==0 {if ctn!=(ctnMax+1)														{screen_save_part(string(working_directory+string("Single/")+string("T (")+string(ctn+1+T_Offset)+string(")."+string(ScreenshotFormat))),0,0,getScreenshotWidth(),getScreenshotHeight());ctn++;} else {screenshot_start++;Screnshot_DELAY = Screnshot_DELAY_par;}};
			if screenshot_start == 6 && Screnshot_DELAY==0 {if card_event_number!=(card_event_numberMax+1)							{screen_save_part(string(working_directory+string("Single/")+string("Event - (")+string(card_event_number+1)+string(")."+string(ScreenshotFormat))),0,0,getScreenshotWidth(),getScreenshotHeight());card_event_number++;} else {screenshot_start++;Screnshot_DELAY = Screnshot_DELAY_par;}};
