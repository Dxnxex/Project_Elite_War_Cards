...
function sc_card_create_events(){
...
sc_card_events_opt2("-2 Elementy",string("Další koupený ")+string_quote_upper(CardShop_Parent_Name[4])+string(" bude neplatný"),"Nějak to ututláme.",1);
...
sc_card_events_desc1(string("Koukej, tohle jsem dostal od dcery, využijeme to hned?"),string("Vždy: Získáváš z obchodu kartu")+string_quote_upper(CardShop_Parent_Name[1])+string("\n(Pokud ji už nevlastníš.)"));
...
sc_card_events_desc1(string("Stavoval jsem se v obchodě pro něco... Koukej."),string("Vždy: Získáváš z obchodu kartu")+string_quote_upper(CardShop_Parent_Name[2])+string("\n(Pokud ji už nevlastníš.)"));
...
sc_card_events_desc1(string("Za mimořádný výkon jsem dostal tohle od Strážkyně. Cítím se hluboce poctěn."),string("Vždy: Získáváš z obchodu kartu")+string_quote_upper(CardShop_Parent_Name[3])+string("\n(Pokud ji už nevlastníš.)"));
...
sc_card_events_desc1(string("Mise zněla jasně zneškodnit nepřítele, ale nic neříkali o prohledávání kapes."),string("Vždy: Získáváš z obchodu či z hřbitova kartu ")+string_quote_upper(CardShop_Parent_Name[21])+string("\n(Pokud ji už nevlastníš.)"));
...
sc_card_events_desc1(string("Tělo vraha mělo být spáleno, ale nic neříkali o jeho majetku."),string("Vždy: Získáváš z obchodu či z hřbitova kartu ")+string_quote_upper(CardShop_Parent_Name[22])+string("\n(Pokud ji už nevlastníš.)"));
...
sc_card_events_desc1(string("Tohle je zĺatá ryba podsvětí a leží tu mrtvý před námi. Co s ní?."),string("Vždy: Získáváš z obchodu či z hřbitova kartu ")+string_quote_upper(CardShop_Parent_Name[23])+string("\n(Pokud ji už nevlastníš.)"));
...
sc_card_events_desc1(string("Tahle čepel už zažila své, možná bych s ní měl něco udělat"),string("Vždy: Kartu ")+string_quote_upper(CardShop_Parent_Name[6])+string(" vracíš do obchodu")+string("\nPokračuj pouze pokud tento předmět vlastníš, jinak dej tuto kartu zpět dospodu balíčku."));
...
sc_card_events_desc1(string("Vypadáš jako bezdomovec, úplně zničená vesta. Co s ní uděláš?"),string("Vždy: Kartu ")+string_quote_upper("VESTA")+string("(Současná úroveň) vracíš do obchodu")+string("\nPokračuj pouze pokud tento předmět vlastníš, jinak dej tuto kartu zpět dospodu balíčku."));
...
sc_card_events_desc1(string("Citíš vítr na nohou, vidíš velice prochozené boty. Co s nimy uděláš?"),string("Vždy: Kartu ")+string_quote_upper("BOTY")+string("(Současná úroveň) vracíš do obchodu")+string("\nPokračuj pouze pokud tento předmět vlastníš, jinak dej tuto kartu zpět dospodu balíčku."));
...
sc_card_events_desc1(string("Přivyděláváš si jako vyhazovač, no a tyhle lidi bys neměl pustit."),string("Vždy: Získáváš z obchodu či z hřbitova kartu ")+string_quote_upper(CardShop_Parent_Name[18])+string("\n(Pokud ji už nevlastníš.)"));
...
sc_card_events_desc1(string("Jsi velký tvrďák, rozhodně ti nic neuteče. Na zemi leží něco bílého."),string("Vždy: Získáváš z obchodu či z hřbitova kartu ")+string_quote_upper(CardShop_Parent_Name[19])+string("\n(Pokud ji už nevlastníš.)"));
...
sc_card_events_desc1(string("Jako dvojitý agent jsi se dostal do nitra Mafie, právě si povídají o politice. Uvěříš jim?"),string("Vždy: Získáváš z obchodu či z hřbitova kartu ")+string_quote_upper(CardShop_Parent_Name[20])+string("\n(Pokud ji už nevlastníš.)"));
