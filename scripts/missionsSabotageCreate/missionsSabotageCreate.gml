...
sc_card_mission_desc_1("140 REUNŮ",1,0);
...
sc_card_mission_desc_1("2 Elementy + 1 Energie",2,3);
sc_card_mission_desc_6(string("Dej soupeři, který ti předal tuto kartu všechny karty s názvem ") +setStringQuoteUpper(CardMissionSabotage_Parent_Name[3]) +string("\n(Toto nech soupeři jako blokátor)"),CardMissionSecure_Parent_Name[03]);
...
sc_card_mission_desc_1("4 Energie",3,0);
...
sc_card_mission_desc_1("80 REUNŮ + 3 Energie",1,3);
...
sc_card_mission_desc("","Hranice",2);
sc_card_mission_desc_1("140 REUNŮ",1,0);
sc_card_mission_desc_6("Ruší efekt karty "+setStringQuoteUpper(CardMissionSecure_Parent_Name[8]),CardMissionSecure_Parent_Name[08]);
...
sc_card_mission_desc("","Stavitelství",2);
sc_card_mission_desc_1("80 REUNŮ + 3 Energie",1,3);
sc_card_mission_desc_6("Ruší efekt karty " +setStringQuoteUpper(CardMissionSecure_Parent_Name[11]) ,CardMissionSecure_Parent_Name[11]);
